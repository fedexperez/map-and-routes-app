...
import 'package:maps_and_routes/helpers/widget_to_marker.dart';
import 'package:maps_and_routes/models/models.dart';
import 'package:maps_and_routes/themes/themes.dart';
...
class MapBloc extends Bloc<MapEvent, MapState> {
      ...
      if (locationState.lastKnownLocation != null) {
        add(
          UpdateUserPolylinesEvent(
              userLocationsHistory: locationState.locationHistory),
        );
      }
  ...
  void _onPolylineNewPoint(
    ...
    final myRoute = Polyline(
      ...
      endCap: Cap.roundCap,
      points: event.userLocationsHistory,
    );
